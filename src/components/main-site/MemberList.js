    ...
    return (
      <div>
        <Container>
          ...
          <Row className="listings">{eboard}</Row>
          <Row>
            <Col className="title text-center">
              <h1>Alpha Class</h1>
            </Col>
          </Row>
          <Row className="listings">{alphaClass}</Row>
          <Row>
            <Col className="title text-center">
              <h1>Beta Class</h1>
            </Col>
          </Row>
          <Row className="listings">{betaClass}</Row>
          <Row>
            <Col className="title text-center">
              <h1>Gamma Class</h1>
            </Col>
          </Row>
          <Row className="listings">{gammaClass}</Row>
          <Row>
            <Col className="title text-center">
              <h1>Delta Class</h1>
            </Col>
          </Row>
          <Row className="listings">{deltaClass}</Row>
          <Row>
            <Col className="title text-center">
              <h1>Alumni</h1>
            </Col>
          </Row>
          <Row className="listings">{alumniClass}</Row>
        </Container>
      </div>
    );
  }
