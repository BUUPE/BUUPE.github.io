...
class EventMngCardBase extends Component {
	...
	componentDidMount() {
	  this.props.firebase.getEvent(this.props.data.index).then(querySnapshot => {
	...
	var startDate = new Date(item.startYear, item.startMonth - 1, item.startDay, item.startHour, item.startMinute, 0, 0).toLocaleString();
	var endDate = new Date(item.endYear, item.endMonth - 1, item.endDay, item.endHour, item.endMinute, 0, 0).toLocaleString();
          ...
          <div className={classes.card}>
            <div className="card-body">
              ...
              <div className="text-center">
				...
				<div className={this.state.editEvent ? classes.buttons : classes.hidden}>
				  <hr />
				  <EventEdit doc={this.state.doc} value={this.props.data} />
				</div>
