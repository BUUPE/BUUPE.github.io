...
class MemberListBase extends Component {
  ...
  render() {
	...
	const alphaClass = this.state.alphaClass.map((item, index) => <MemberMngCard data={item} key={index} pos={false} />)
	const betaClass = this.state.betaClass.map((item, index) => <MemberMngCard data={item} key={index} pos={false} />)
	const gammaClass = this.state.gammaClass.map((item, index) => <MemberMngCard data={item} key={index} pos={false} />)
	const deltaClass = this.state.deltaClass.map((item, index) => <MemberMngCard data={item} key={index} pos={false} />)
	const alumniClass = this.state.alumniClass.map((item, index) => <MemberMngCard data={item} key={index} pos={true} />)
